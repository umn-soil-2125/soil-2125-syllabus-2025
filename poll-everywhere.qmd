...
Poll Everywhere is a live polling and survey app that we will be using throughout the semester. It will be used to respond to questions in lecture for attendance purposes (**NOTE: For full credit on the [Lecture Questions](assignments-points-grades.qmd) portion of your grade, you are required to attend a minimum of 25 of the 31 lectures throughout the semester. If you attend more than 25 lectures, you will receive extra credit.**) If you are a registered student in SOIL 2125, you will have had an account created for you in Poll Everywhere by your instructors. If you have previously had an account set up for Poll Everywhere in another course with your umn.edu email, you may need to login using your existing account. Below are the steps to get you started using the app.
